...
<?
$ob_ofise=CIBlockElement::GetList(Array("SORT"=>"ASC"),Array('IBLOCK_ID'=>6,'PROPERTY_KORPUS'=>$arResult['ID'],'!PREVIEW_TEXT'=>false,'ACTIVE'=>'Y'),false,false,Array('PROPERTY_ETAJ'));
while($ar = $ob_ofise->GetNext()) {
