...
// 1 floor
	...
	floor11.data("id", 'fl11').data("value", "korpus-1/1.html");
...
// 2 floor
	...
	.attr({fill: "#0DBED6", opacity:"0",stroke:'none' });
	name: 'Korpus-2';
	floor12.data("id", 'fl12').data("value", "korpus-1/2.html");
...
// 3 floor
	...
	.attr({fill: "#0DBED6", opacity:"0", stroke:'none' });
	name: 'Korpus-3';
	floor13.data("id", 'kor3').data("value", "korpus-1/3.html");
...
// 4 floor
	...
	.attr({fill: "#0DBED6", opacity:"0", stroke:'none' });
	name: 'Korpus-3';
	floor14.data("id", 'kor3').data("value", "korpus-1/4.html");
...
// 5 floor
	...
	.attr({fill: "#0DBED6", opacity:"0", stroke:'none' });
	name: 'Korpus-3';
	floor15.data("id", 'kor3').data("value", "korpus-1/5.html");
...
// 6 floor
	...
	.attr({fill: "#0DBED6", opacity:"0", stroke:'none' });
	name: 'Korpus-3';
	floor16.data("id", 'kor3').data("value", "korpus-1/6.html").data("marker", "floor16Mark");
